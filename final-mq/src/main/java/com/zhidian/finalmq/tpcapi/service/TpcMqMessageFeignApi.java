package com.zhidian.finalmq.tpcapi.service;

import com.zhidian.finalmq.base.wrapper.Wrapper;
import com.zhidian.finalmq.model.dto.TpcMqMessageDto;
import com.zhidian.finalmq.tpcapi.service.hystrix.TpcMqMessageFeignApiHystrix;
 ...
 */
@FeignClient(value = "paascloud-provider-tpc",
        //configuration = OAuth2FeignAutoConfiguration.class,
        fallback = TpcMqMessageFeignApiHystrix.class)
